        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-10">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <div className="inline-flex items-center gap-2 px-5 py-2 glass-card-dark dark:bg-surface/50 backdrop-blur-md rounded-full border border-border text-gold text-[10px] font-bold uppercase tracking-[0.2em]">
                <Sparkles className="w-3 h-3" />
                Specialized Service
              </div>
              
              <h1 className="text-5xl md:text-7xl font-bold font-heading text-text-dark uppercase tracking-tight leading-[1.1]">
            ...
            >
              {[
                ...
                <div key={i} className="group p-6 bg-surface backdrop-blur-lg rounded-3xl border border-border hover:border-gold/30 transition-all duration-500 shadow-sm">
                  ...
                  <p className="text-text-muted text-[11px] font-medium leading-relaxed">{feature.desc}</p>
                </div>
              ))}
            </motion.div>
          </div>
            ...
            >
              ...
              <div className="relative bg-surface p-8 md:p-10 rounded-[2.5rem] border border-border shadow-xl">
                <div className="mb-10 text-center">
                  <h2 className="text-3xl font-bold font-heading text-text-dark uppercase tracking-tight mb-2">
              ...
              <div className="mt-8 flex items-center justify-center gap-6 opacity-40 grayscale transition-all hover:grayscale-0 hover:opacity-100">
                 <div className="flex flex-col items-center">
                    ...
                    <span className="text-[8px] font-medium text-gold uppercase mt-0.5 tracking-tighter">Certified Provider</span>
                 </div>
                 <div className="w-px h-8 bg-border" />
                 <div className="flex flex-col items-center">
                    <span className="text-[10px] font-bold uppercase text-text-dark tracking-widest leading-none">Instant Support</span>
                    <span className="text-[8px] font-medium text-gold uppercase mt-0.5 tracking-tighter">24/7 Concierge</span>
                 </div>
              </div>
            </motion.div>
          </div>
